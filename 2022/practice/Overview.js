...
<head>
    ...
    <meta property="og:title" content="111 學年度 全國資訊學科能力競賽模擬賽－記分板">
    <meta property="og:type" content="website">
    <title>111 學年度 全國資訊學科能力競賽模擬賽－記分板</title>
    <meta name="description" content="111 學年度 全國資訊學科能力競賽模擬賽－記分板">
    <link rel="icon" type="image/png" sizes="32x32" href="./imgs/favicon_32x32.png">
    <link rel="icon" type="image/png" sizes="16x16" href="./imgs/favicon_16x16.png">
<style>
/* page related */
*,
*::before,
...
<body>
    ...
    <main>
        <div id="title-div" class="">
            <span class="no-break" id="title-row1">111 學年度普通型高級中等學校</span><br>
            <span class="no-break" id="title-row2">資訊學科能力競賽決賽 模擬賽</span><br>
            <span class="no-break" id="title-row3"><img id="calendar-icon" src="./imgs/calendar_from_flaticon.svg"> 12/10（六）上午 9:00 至 下午 2:00</span>
        </div>
        <div id="text-div">
            <span id="text-span">
